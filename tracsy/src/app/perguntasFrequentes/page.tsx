...
function PerguntasFrequentesPage() {
  ...
  return (
    ...
    <div className="sm:w-full md:w-[90%] lg:w-[80%] xl:w-[60%] 2xl:w-[50%] mx-auto ">
      ...
      {/*Usa o componente page title e passa o nome da página.*/}
      <PageTitle title="Perguntas frequentes" />

      <div className="w-full p-10">
        {/*Usa o componente accordion para organizar as perguntas*/}
          ...
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              <div className="flex flex-col text-center m-4 rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)] p-5">
                ...
                <br />
                <p>Veja sobre em {/*link*/}<a href="/login" className="text-blue-700 hover:underline">Login</a> ou veja a imagem abaixo:</p>
                <br />
